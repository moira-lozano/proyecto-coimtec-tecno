        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6">
            ...
            <div class="mb-6 p-4 bg-gray-50 rounded-lg">
              <h3 class="text-lg font-medium text-gray-900">{{ marca.nombre }}</h3>
              <p class="text-sm text-gray-500">
                Creada el {{ formatDate(marca.created_at) }}
              </p>
            </div>
...
const submit = () => {
  // VERSIÓN MÁS BÁSICA CON MÉTODO PATCH:
  form.patch(`/marcas/${props.marca.id}`, {
    onSuccess: () => {
